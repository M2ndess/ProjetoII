    ...
    public void handleDeactivateButton(ActionEvent event) {
        ...
        if (selectedCliente != null) {
            ...
            try (Connection conn = connection.getConnection();
                ...
                String newEstadoConta;
                if (previousEstadoConta == null) {
                    newEstadoConta = "Inativo";
                } else {
                    newEstadoConta = previousEstadoConta.equals("Ativo") ? "Inativo" : "Ativo";
                }

                stmt.setString(1, newEstadoConta);
                stmt.setInt(2, selectedCliente.getId());
                stmt.executeUpdate();
